    ...
    Sub Ubah()
        ...
        For Each rw As DataGridViewRow In DataGridView1.Rows
            If Not rw.Cells(0).Value = "" Then
                Cmd = New SqlCommand("Update PERMINTAAN_PEMBELIAN_DETIL set NO_URUT = '" & rw.Cells(0).Value & "', NAMA_BARANG='" & rw.Cells(1).Value & "', NAMA_BARANG_2+'" & rw.Cells(2).Value & "', NAMA_BARANG_3='" & rw.Cells(3).Value & "', NAMA_BARANG_4='" & rw.Cells(4).Value & "', NAMA_BARANG_5='" & rw.Cells(5).Value & "', NAMA_BARANG_6'" & rw.Cells(6).Value & "', NAMA_BARANG_7='" & rw.Cells(7).Value & "', NAMA_BARANG_8='" & rw.Cells(8).Value & "', NAMA_BARANG_9='" & rw.Cells(9).Value & "', NAMA_BARANG_10='" & rw.Cells(10).Value & "', JUMLAH='" & rw.Cells(11).Value & "', SATUAN='" & rw.Cells(12).Value & "', KETERANGAN_1='" & rw.Cells(13).Value & "', KETERANGAN_2='" & rw.Cells(14).Value & "', KETERANGAN_3='" & rw.Cells(15).Value & "', KETERANGAN_4='" & rw.Cells(16).Value & "', KETERANGAN_5='" & rw.Cells(17).Value & "', KETERANGAN_6='" & rw.Cells(18).Value & "', KETERANGAN_7='" & rw.Cells(19).Value & "', KETERANGAN_8='" & rw.Cells(20).Value & "', KETERANGAN_9='" & rw.Cells(21).Value & "', KETERANGAN_10='" & rw.Cells(22).Value & "' WHERE NO_BUKTI='" & TbNoBukti.Text & "'", Conn)
                Rd.Close()
                Cmd.ExecuteNonQuery()
            End If
        Next
